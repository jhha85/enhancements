...
- [Proposal](#proposal)
  - [Proposed Changes](#proposed-changes)
    - [New Component: Memory Manager](#new-component-memory-manager)
      - [Calculate NUMA node affinity for memory and hugepages](#calculate-numa-node-affinity-for-memory-and-hugepages)
      - [Provide topology hint for Topology Manager](#provide-topology-hint-for-topology-manager)
      - [Isolate memory and hugepages for a container](#isolate-memory-and-hugepages-for-a-container)
